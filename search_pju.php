        ...
        <div class="container"> <a class="navbar-brand" href="homeu.php"><img src="img/assets/home.png" width="30" height="30" alt="" class="d-inline-block align-top">&nbspเว็บไซต์จัดเก็บโครงงาน</a>
            ...
            <div class="collapse navbar-collapse row" id="navbarNav">
                <ul class="navbar-nav col">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="homeu.php">หน้าแรก <span class="sr-only">(current)</span></a></li>
                    <li class="nav-item active"> <a class="nav-link" href="search_pju.php">ค้นหาโครงงาน</a></li
                </ul>
